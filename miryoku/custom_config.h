...
U_MT(LGUI, A),     U_MT(LALT, R),     &macro_eurkey S,    U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
&macro_eurkey Z, U_MT(RALT, X),     &macro_eurkey C ,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
