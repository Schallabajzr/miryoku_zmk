...
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL,  U_EURKEY(S)),    U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON,  U_EURKEY(Z)), U_MT(RALT, X),     &kp  U_EURKEY(C),             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
